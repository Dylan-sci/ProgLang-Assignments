...
and typeof_bop env bop e1 e2 =
  ...
  | Mult, TInt, TInt -> TInt
  | Div, TInt, TInt -> TInt
  | Leq, TInt, TInt -> TBool | Leq, TFloat, TFloat -> TBool
  | Geq, TInt, TInt -> TBool | Geq, TFloat, TFloat -> TBool
  | AddFloat, TFloat, TFloat -> TFloat
  | SubFloat, TFloat, TFloat -> TFloat
  | MultFloat, TFloat, TFloat -> TFloat
  | DivFloat, TFloat, TFloat -> TFloat
  | _ -> failwith bop_err
...
and eval_bop bop e1 e2 = 
  ...
  | Leq , Int a, Int b -> Bool (a <= b) | Leq, Float a, Float b -> Bool (a <= b)
  | Geq, Int a, Int b -> Bool (a >= b) | Geq, Float a, Float b -> Bool (a >= b)
  | AddFloat, Float a, Float b -> Float (round_dfrac 2 (a +. b))
  | SubFloat, Float a, Float b -> Float (round_dfrac 2 (a -. b))
  | MultFloat, Float a, Float b -> Float (round_dfrac 2 (a *. b))
  | DivFloat, Float a, Float b -> Float (round_dfrac 2 (a /. b))
  | _ -> failwith bop_err
